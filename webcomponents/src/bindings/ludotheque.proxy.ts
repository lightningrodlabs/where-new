...
export class LudothequeProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "zLudotheque";
  static override readonly FN_NAMES = ludothequeFunctionNames;
  static override readonly ENTRY_TYPES = Object.values(LudothequeUnitEnum);
  static override readonly LINK_TYPES = Object.values(LudothequeLinkType);
